...
public interface ComponentWrapper
{
	 ...
	 * If the min/pref/max height depends on it's width return {@link LayoutUtil#HORIZONTAL}
	 * If the min/pref/max width depends on it's height (not common) return {@link LayoutUtil#VERTICAL}
