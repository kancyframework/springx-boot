...
public class PopupMenuUtils {
     ...
     * @return
     */
    public static JMenuItem addMenuItem(JMenu menu, String menuName,
                                        ActionListener actionListener, String actionCommand) {
        return addMenuItem(menu, menuName, actionListener, actionCommand, null);
    }
    ...
    public static List<AbstractButton> findAbstractButtons(MenuElement menuElement){
        ...
        findAbstractButton(list, menuElement.getSubElements());
        return list;
    }
    ...
    public static void findAbstractButton(List<AbstractButton> list, MenuElement[] subElements) {
        for (MenuElement subElement : subElements) {
            ...
            if (component instanceof AbstractButton){
                list.add(AbstractButton.class.cast(component));
            }
            findAbstractButton(list, subElement.getSubElements());
        }
    }
