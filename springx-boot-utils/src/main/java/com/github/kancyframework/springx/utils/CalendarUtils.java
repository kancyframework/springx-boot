...
public class CalendarUtils {
    ...
    public static String lunarToSolar(String lunarDate) throws Exception {
        return lunarToSolar(lunarDate, false);
    }
    ...
    public static String solarToLunar(String solarDate) throws Exception{
        ...
        //  "阴历："+lunarYear+"年"+(leapMonthFlag&(lunarMonth==leapMonth)?"闰":"")+lunarMonth+"月"+lunarDay+"日";
        return String.format("%02d%02d%02d", lunarYear, lunarMonth, lunarDay);
    }
